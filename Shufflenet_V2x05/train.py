...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./Shufflenet_V2x05/table_net_val.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./Shufflenet_V2x05/conf_net_val.jpg')
...
def main():
    ...
    save_path = './Shufflenet_V2x05/shufflenet_v2_x0_5.pth'#模型最终保存路径
    data_transform = {
    ...
    with open('./Shufflenet_V2x05/class_indices.json', 'w') as json_file:
    ...
    with open('./Shufflenet_V2x05/acc_time_net_val.txt', 'a+', encoding='utf-8') as f:
    ...
    plt.legend()
    plt.savefig('./Shufflenet_V2x05/acc_net.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
    ...
    plt.legend()
    plt.savefig('./Shufflenet_V2x05/loss_net.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
