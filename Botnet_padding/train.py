...
from Botnet.BotNet  import ResNet50
import xlrd
...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./Botnet_padding/table_net-padding_val.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    # print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./Botnet_padding/conf_net-padding_val.jpg')
...
def main():
    ...
    save_path = './Botnet_padding/Botnet_padding.pth'#模型最终保存路径
    data_transform = {
    ...
    with open('./Botnet_padding/class_indices.json', 'w') as json_file:
    ...
    with open('./Botnet_padding/acc_time_net-padding_val.txt', 'a+', encoding='utf-8') as f:
    ...
    plt.legend()
    plt.savefig('./Botnet_padding/acc_net-padding.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
    ...
    plt.legend()
    plt.savefig('./Botnet_padding/loss_net-padding.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
