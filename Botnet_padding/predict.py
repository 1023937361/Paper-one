...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./Botnet_padding/table_net-padding_test.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    # print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./Botnet_padding/conf_net-padding_test.jpg')
...
def main():
    ...
    weights_path = "./Botnet_padding/Botnet_padding.pth"
    ...
    with open('./Botnet_padding/acc_time_net-padding_test.txt', 'a+', encoding='utf-8') as f:
