...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./ResNet18_Padding/table_net-padding_val.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./ResNet18_Padding/conf_net-padding_val.jpg')
...
def main():
    ...
    save_path = './ResNet18_Padding/resnet18-padding.pth'#模型最终保存路径
    data_transform = {
    ...
    with open('./ResNet18_Padding/class_indices.json', 'w') as json_file:
    ...
    net = models.resnet18(num_classes=5,pretrained= False)
    ...
    with open('./ResNet18_Padding/acc_time_net-padding_val.txt', 'a+', encoding='utf-8') as f:
    ...
    plt.legend()
    plt.savefig('./ResNet18_Padding/acc_net-padding.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
    ...
    plt.legend()
    plt.savefig('./ResNet18_Padding/loss_net-padding.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
