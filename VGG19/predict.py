...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./VGG19/table_net_test.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./VGG19/conf_net_test.jpg')
...
def main():
    ...
    with open('./VGG19/acc_time_net_test.txt', 'a+', encoding='utf-8') as f:
