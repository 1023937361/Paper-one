...
from T2T_VIT_padding.t2t_vit import T2t_vit_7
import xlrd
...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./T2T_VIT_padding/table_net-padding_val.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./T2T_VIT_padding/conf_net-padding_val.jpg')
...
def main():
    ...
    save_path = './T2T_VIT_padding/t2t_vit-padding.pth'#模型最终保存路径
    data_transform = {
    ...
    net = T2t_vit_7(num_classes=5,pretrained= False)
    ...
    with open('./T2T_VIT_padding/acc_time_net-padding_val.txt', 'a+', encoding='utf-8') as f:
    ...
    plt.legend()
    plt.savefig('./T2T_VIT_padding/acc_net-padding.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
    ...
    plt.legend()
    plt.savefig('./T2T_VIT_padding/loss_net-padding.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
