...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./VGG16_Padding/table_vgg13-padding_test.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./VGG16_Padding/conf_vgg13-padding_test.jpg')
...
def main():
    ...
    weights_path = "./VGG16_Padding/vgg16-padding.pth"
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            test_bar = tqdm(test_loader, colour='blue')
    ...
    with open('./VGG16_Padding/acc_time_vgg13-padding_test.txt', 'a+', encoding='utf-8') as f:
