...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./VGG13_Padding/table_vgg13-padding_test.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./VGG13_Padding/conf_vgg13-padding_test.jpg')
...
def main():
    ...
    weights_path = "./VGG13_Padding/vgg13-padding.pth"
    ...
    with open('./VGG13_Padding/acc_time_vgg13-padding_test.txt', 'a+', encoding='utf-8') as f:
