...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./VGG19_Padding/table_vgg13-padding_test.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./VGG19_Padding/conf_vgg13-padding_test.jpg')
...
def main():
    ...
    weights_path = "./VGG19_Padding/vgg19-padding.pth"
    ...
    with open('./VGG19_Padding/acc_time_vgg13-padding_test.txt', 'a+', encoding='utf-8') as f:
