...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./Botnet/table_net_test.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    # print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./Botnet/conf_net_test.jpg')
...
def main():
    ...
    weights_path = "./Botnet/Botnet.pth"
    ...
    with open('./Botnet/acc_time_net_test.txt', 'a+', encoding='utf-8') as f:
