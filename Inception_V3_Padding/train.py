...
from Inception_V3_Padding.inception_v3  import Inception3
import xlrd
...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./Inception_V3_Padding/table_net-padding_val.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./Inception_V3_Padding/conf_net-padding_val.jpg')
...
def main():
    ...
    save_path = './Inception_V3_Padding/Inception_V3-padding.pth'#模型最终保存路径
    data_transform = {
    ...
    with open('./Inception_V3_Padding/class_indices.json', 'w') as json_file:
    ...
    with open('./Inception_V3_Padding/acc_time_net-padding_val.txt', 'a+', encoding='utf-8') as f:
    ...
    plt.legend()
    plt.savefig('./Inception_V3_Padding/acc_net-padding.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
    ...
    plt.legend()
    plt.savefig('./Inception_V3_Padding/loss_net-padding.jpg')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
