...
def summary_table(matrix,num_classes,labels):
    ...
    with open('./Inception_V3_Padding/table_net-padding_test.txt', 'a+') as f:
        f.write(str(table))
    f.close()
    print(table)
...
def plot_conf(matrix,num_classes,labels):
    ...
    plt.tight_layout()
    plt.savefig('./Inception_V3_Padding/conf_net-padding_test.jpg')
...
def main():
    ...
    weights_path = "./Inception_V3_Padding/Inception_V3-padding.pth"
    ...
    with open('./Inception_V3_Padding/acc_time_net-padding_test.txt', 'a+', encoding='utf-8') as f:
    ...
    write_excel_xls_append('./standarddata_test.xls',[[p*100,r*100,f*100,round(val_accurate*100,2)]])
